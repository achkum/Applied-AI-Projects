...
def _cmd_download(args: argparse.Namespace) -> int:
    from token_optimizer.compress.llmlingua import download_and_quantize
...
def _cmd_mcp(args: argparse.Namespace) -> int:
    from token_optimizer.mcp_server import main as mcp_main
...
def _cmd_web(args: argparse.Namespace) -> int:
    ...
    from token_optimizer.webapp import app_factory

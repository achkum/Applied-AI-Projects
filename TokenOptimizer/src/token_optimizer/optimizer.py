...
from token_optimizer.cache_optimizer import optimize_for_cache
...
from token_optimizer.normalize.extract import ExtractionError, extract_to_markdown, is_binary_format
from token_optimizer.normalize.structured import CsvNormalizer, JsonYamlNormalizer
from token_optimizer.normalize.textclean import TextCleanNormalizer
...
def optimize_payload(
    ...
    if config.enable_compression:
        from token_optimizer.compress import compress_payload

...
Counting is delegated to the per-provider tokenizer in ``token_optimizer.providers``: exact where a
...
from token_optimizer.providers import provider_for, resolve, tokenizer_for
from token_optimizer.types import Provider, TokenCount
